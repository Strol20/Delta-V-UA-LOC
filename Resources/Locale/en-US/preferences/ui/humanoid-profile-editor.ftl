...
humanoid-profile-editor-guidebook-button-tooltip = Натисніть, щоб дізнатися більше
...
humanoid-profile-editor-department-jobs-label = Вакансії: «{$departmentName}»
...
humanoid-profile-editor-no-traits = Особливості недоступні

humanoid-profile-editor-trait-count-hint = Доступно балів: [{$current}/{$max}]
