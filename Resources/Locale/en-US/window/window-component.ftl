...
comp-window-damaged-4 = [color=yellow]На його поверхні є кілька великих тріщин.[/color]
comp-window-damaged-5 = [color=orange]Має глибокі тріщини у кількох шарах.[/color]
comp-window-damaged-6 = [color=red]Воно вкрай потріскане і на межі розбиття.[/color]
